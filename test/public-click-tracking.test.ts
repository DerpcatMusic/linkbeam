...
describe("public smartlink click tracking", () => {
  it("marks destination links for browser-side click tracking", () => {
    ...
    expect(smartlinkPage).toContain("data-meta-events");
    expect(smartlinkPage).toContain("resolveOutboundMetaEvents");
    expect(smartlinkPage).not.toContain("data-paid-event-name");
